    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Expenses_Persons_PaidByPersonId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpensePersons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExpensePersons_Expenses_ExpenseId",
                        column: x => x.ExpenseId,
                        principalTable: "Expenses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExpensePersons_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventPersons_EventId_PersonId",
                table: "EventPersons",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpensePersons_ExpenseId_PersonId",
                table: "ExpensePersons",
                columns: new[] { "ExpenseId", "PersonId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExpensePersons_PersonId",
                table: "ExpensePersons",
                column: "PersonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenses_PaidByPersonId",
                table: "Expenses",
